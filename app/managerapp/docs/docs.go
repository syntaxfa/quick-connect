...
const docTemplate = `{
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/userservice.IdentifyClientRequest"
                        }
                    }
                ],
                "responses": {
                    "201": {
                        "description": "Created",
                        "schema": {
                            "$ref": "#/definitions/userservice.IdentifyClientResponse"
                        }
                    },
                    "400": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/userservice.RegisterGuestUserRequest"
                        }
                    }
                ],
                "responses": {
                    "201": {
                        "description": "Created",
                        "schema": {
                            "$ref": "#/definitions/userservice.RegisterGuestUserResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/userservice.UpdateGuestUserRequest"
                        }
                    }
                ],
                "responses": {
                    "201": {
                        "description": "Created",
                        "schema": {
                            "$ref": "#/definitions/userservice.UpdateGuestUserResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
    ...
    "definitions": {
        ...
        "userservice.IdentifyClientRequest": {
            "type": "object",
            "properties": {
                "email": {
                    "type": "string"
        ...
        "userservice.IdentifyClientResponse": {
            "type": "object",
            "properties": {
                "avatar": {
                    "type": "string"
        ...
        "userservice.RegisterGuestUserRequest": {
            "type": "object",
            "properties": {
                "email": {
                    "type": "string"
        ...
        "userservice.RegisterGuestUserResponse": {
            "type": "object",
            "properties": {
                "avatar": {
                    "type": "string"
        ...
        "userservice.UpdateGuestUserRequest": {
            "type": "object",
            "properties": {
                "email": {
                    "type": "string"
        ...
        "userservice.UpdateGuestUserResponse": {
            "type": "object",
            "properties": {
                "avatar": {
                    "type": "string"
