/**
 * Quick Connect SDK - PREMIUM DARK UI (English Version)
...
(function(window, document) {
    ...
    const QuickConnect = {
        config: {
            managerUrl: 'https://manager-qc.syntaxfa.ir',
            chatUrl: 'wss://chat-qc.syntaxfa.ir/chats/clients',
            chatApiUrl: 'https://chat-qc.syntaxfa.ir',
